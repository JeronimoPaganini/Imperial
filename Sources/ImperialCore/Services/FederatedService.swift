...
public protocol FederatedService {
    ...
    init(routes: RoutesBuilder, authenticate: [PathComponent], authenticateCallback: ((Request) throws -> (EventLoopFuture<Void>))?, callback: String, scope: [String], completion: @escaping (Request, String) throws -> (EventLoopFuture<ResponseEncodable>)) throws
}
